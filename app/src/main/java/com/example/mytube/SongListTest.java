...
public class SongListTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_song_list_test);
        ...
        for (File individualFile : allFiles) {
            if (individualFile.isDirectory() && !individualFile.isHidden()) {
                ...
                if (individualFile.getName().endsWith(".mp3") ||
                        individualFile.getName().endsWith(".acc") ||
    ...
    private void displayAudioSongsName() {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(SongListTest.this, android.R.layout.simple_list_item_1, itemAll);
        ...
        mSongList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(SongListTest.this, Main2Activity.class);
